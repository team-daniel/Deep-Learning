...
To better understand how RL works, we will look at the popular Q Learning algorithm that many RL agents use. Q Learning looks to pick the best action possible by assinging a state action pair a value that determines its quality. Before we look at it, let's look at a few equations first.
